...
func (p *HbaseClient) GetRegionInfo(ctx context.Context, row Text) (r *TRegionInfo, err error) {
	var _args89 HbaseGetRegionInfoArgs
	_args89.Row = row
	var _result90 HbaseGetRegionInfoResult
...
func (p *HbaseClient) Append(ctx context.Context, append *TAppend) (r []*TCell, err error) {
	var _args91 HbaseAppendArgs
	_args91.Append = append
	var _result92 HbaseAppendResult
...
func (p *HbaseClient) CheckAndPut(ctx context.Context, tableName Text, row Text, column Text, value Text, mput *Mutation, attributes map[string]Text) (r bool, err error) {
	var _args93 HbaseCheckAndPutArgs
	...
	var _result94 HbaseCheckAndPutResult
...
func NewHbaseProcessor(handler Hbase) *HbaseProcessor {
	...
	self95 := &HbaseProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self95.processorMap["enableTable"] = &hbaseProcessorEnableTable{handler: handler}
	self95.processorMap["disableTable"] = &hbaseProcessorDisableTable{handler: handler}
	self95.processorMap["isTableEnabled"] = &hbaseProcessorIsTableEnabled{handler: handler}
	self95.processorMap["compact"] = &hbaseProcessorCompact{handler: handler}
	self95.processorMap["majorCompact"] = &hbaseProcessorMajorCompact{handler: handler}
	self95.processorMap["getTableNames"] = &hbaseProcessorGetTableNames{handler: handler}
	self95.processorMap["getColumnDescriptors"] = &hbaseProcessorGetColumnDescriptors{handler: handler}
	self95.processorMap["getTableRegions"] = &hbaseProcessorGetTableRegions{handler: handler}
	self95.processorMap["createTable"] = &hbaseProcessorCreateTable{handler: handler}
	self95.processorMap["deleteTable"] = &hbaseProcessorDeleteTable{handler: handler}
	self95.processorMap["get"] = &hbaseProcessorGet{handler: handler}
	self95.processorMap["getVer"] = &hbaseProcessorGetVer{handler: handler}
	self95.processorMap["getVerTs"] = &hbaseProcessorGetVerTs{handler: handler}
	self95.processorMap["getRow"] = &hbaseProcessorGetRow{handler: handler}
	self95.processorMap["getRowWithColumns"] = &hbaseProcessorGetRowWithColumns{handler: handler}
	self95.processorMap["getRowTs"] = &hbaseProcessorGetRowTs{handler: handler}
	self95.processorMap["getRowWithColumnsTs"] = &hbaseProcessorGetRowWithColumnsTs{handler: handler}
	self95.processorMap["getRows"] = &hbaseProcessorGetRows{handler: handler}
	self95.processorMap["getRowsWithColumns"] = &hbaseProcessorGetRowsWithColumns{handler: handler}
	self95.processorMap["getRowsTs"] = &hbaseProcessorGetRowsTs{handler: handler}
	self95.processorMap["getRowsWithColumnsTs"] = &hbaseProcessorGetRowsWithColumnsTs{handler: handler}
	self95.processorMap["mutateRow"] = &hbaseProcessorMutateRow{handler: handler}
	self95.processorMap["mutateRowTs"] = &hbaseProcessorMutateRowTs{handler: handler}
	self95.processorMap["mutateRows"] = &hbaseProcessorMutateRows{handler: handler}
	self95.processorMap["mutateRowsTs"] = &hbaseProcessorMutateRowsTs{handler: handler}
	self95.processorMap["atomicIncrement"] = &hbaseProcessorAtomicIncrement{handler: handler}
	self95.processorMap["deleteAll"] = &hbaseProcessorDeleteAll{handler: handler}
	self95.processorMap["deleteAllTs"] = &hbaseProcessorDeleteAllTs{handler: handler}
	self95.processorMap["deleteAllRow"] = &hbaseProcessorDeleteAllRow{handler: handler}
	self95.processorMap["increment"] = &hbaseProcessorIncrement{handler: handler}
	self95.processorMap["incrementRows"] = &hbaseProcessorIncrementRows{handler: handler}
	self95.processorMap["deleteAllRowTs"] = &hbaseProcessorDeleteAllRowTs{handler: handler}
	self95.processorMap["scannerOpenWithScan"] = &hbaseProcessorScannerOpenWithScan{handler: handler}
	self95.processorMap["scannerOpen"] = &hbaseProcessorScannerOpen{handler: handler}
	self95.processorMap["scannerOpenWithStop"] = &hbaseProcessorScannerOpenWithStop{handler: handler}
	self95.processorMap["scannerOpenWithPrefix"] = &hbaseProcessorScannerOpenWithPrefix{handler: handler}
	self95.processorMap["scannerOpenTs"] = &hbaseProcessorScannerOpenTs{handler: handler}
	self95.processorMap["scannerOpenWithStopTs"] = &hbaseProcessorScannerOpenWithStopTs{handler: handler}
	self95.processorMap["scannerGet"] = &hbaseProcessorScannerGet{handler: handler}
	self95.processorMap["scannerGetList"] = &hbaseProcessorScannerGetList{handler: handler}
	self95.processorMap["scannerClose"] = &hbaseProcessorScannerClose{handler: handler}
	self95.processorMap["getRegionInfo"] = &hbaseProcessorGetRegionInfo{handler: handler}
	self95.processorMap["append"] = &hbaseProcessorAppend{handler: handler}
	self95.processorMap["checkAndPut"] = &hbaseProcessorCheckAndPut{handler: handler}
	return self95
}
...
type HbaseGetTableNamesResult struct {
	Success []Text `thrift:"succes
s,0" db:"success" json:"success,omitempty"`
	Io *IOError `thrift:"io,1" db:"io" json:"io,omitempty"`
}
